export const cardTypes = {
  ...
  export const cards = {
    ...
    gardens: {name: "Gardens ⚫️", type: "Action-Victory", cost: 4, points: 0, description: "Worth 1 VP for every 10 cards in your deck (rounded down)."},
    treasury: {name: "Treasury ⚫️", type: "Action", cost: 5, description: "+1 Card, +1 Action, +1 Coin"},
